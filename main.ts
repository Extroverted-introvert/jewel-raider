...
namespace SpriteKind {
    export const jewel2 = SpriteKind.create()
}
...
function spawn_jewels() {
    ...
    for (let value of scene.getTilesByType(9)) {
        jewel22 = sprites.create(img`
            ...
            `, SpriteKind.jewel2)
        value.place(jewel22)
        animation.attachAnimation(jewel22, jewelanim2)
        animation.setAction(jewel22, ActionKind.jewel)
    }
}
...
scene.onHitTile(SpriteKind.Enemy, 4, function on_hit_tile(sprite: Sprite) {
    mySprite2.vx = 50
    mysprite3.vx = -50
})
function jewelanim() {
...
scene.onHitTile(SpriteKind.Player, 3, function on_hit_tile2(sprite2: Sprite) {
    
    lvlcomplete = 1
})
scene.onHitTile(SpriteKind.Enemy, 15, function on_hit_tile3(sprite3: Sprite) {
    sprite3.destroy(effects.ashes, 500)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.jewel2, function on_on_overlap(sprite4: Sprite, otherSprite: Sprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function on_on_overlap2(sprite5: Sprite, otherSprite2: Sprite) {
