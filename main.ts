...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite5, otherSprite2) {
    mySprite.destroy()
    mySprite2.destroy()
    mysprite3.destroy()
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.jewel2, function (sprite4, otherSprite) {
...
scene.onHitTile(SpriteKind.Player, 3, function (sprite2) {
    lvlcomplete = 1
})
function new_level () {
    mySprite2.destroy()
    ...
    if (levelnum == 3) {
        ...
        scene.setTileMap(img`
            ...
            2 b b 4 b 4 4 b b 4 4 b 4 b b 7 
...
scene.onHitTile(SpriteKind.Enemy, 15, function (sprite3) {
